...
<?php include 'includes/topbar.php'; ?>
    ...
    <title>Shop Info - Terms and Conditions</title>
	<?php
                       ...
                       <table class="table table-bordered" id="shopInfo" width="100%" cellspacing="0">
						   ...
						   <tbody>
							<?php
								...
								$sql = "SELECT shopInfo_id, terms_conditions FROM shop_info";
								$result = mysqli_query($conn, $sql);
								while($row=mysqli_fetch_array($result)){
							?>
							<tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
					<div class="container-fluid">
						<form method="POST" action="includes/si_add_tac.php">
							<div class="row">
								<div class="col-lg-10">
	...
	<div class='modal fade' id='editText' tabindex='-1' role='dialog' aria-hidden='true'>
		<div class='modal-dialog modal-dialog-centered' role='document'>
			...
			<div class='modal-body'>
				<form action="includes/si_edit_tac.php" method='POST'>
			...
			<div class='modal-footer'>
					...
					<a href="si_edit_tac.php?id=<?php echo $row['shopInfo_id']; ?>">
